  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          width: triggerIcon ? "auto" : folderSize.width,
          height: triggerIcon ? "auto" : folderSize.height,
      ...
      >
        ...
        {displayImages.map((image, index) => {
          ...
          const teaseY = triggerIcon ? 0 : -4 - (totalImages - 1 - index) * 1;
          const teaseRotation =
            totalImages === 1
              ? 0
              : totalImages === 2
          ...
          return (
            <motion.div
              ...
              animate={{
                ...
                opacity: triggerIcon && !isHovered ? 0 : 1,
              }}
              transition={{
                type: "spring",
                stiffness: 400,
